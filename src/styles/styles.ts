...
export const navlinks = "hidden absolute top-full right-0 flex flex-col gap-2 bg-[var(--light)] p-4 z-50";
...
export const footer = "w-full bg-[var(--accent)] border-t  text-[var(--light)] text-sm";
